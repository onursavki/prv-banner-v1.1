document.addEventListener('DOMContentLoaded', function () {
    ...
    if (today >= banner1StartDate && today <= banner1EndDate) {
        ...
        document.getElementById('banner-container').style.background = `linear-gradient(to right, #ffffff 50%, transparent 50%), linear-gradient(to top, #ea2421, #dd1106, #d40701)`;
